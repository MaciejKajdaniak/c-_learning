namespace Delegaty_1
{
    internal class Program
    {
        ...
        public static void DisplayResult(Operation op, int x,int y)
        {
            ...
            {
                result = op(x, y);
                Console.WriteLine("Działanie {0} liczb {1} i {2} wynosi {3}", op.Method.Name, x, y, result);
            }
        }
        ...
        public static int GetIntFromUser(string prompt)
        {
            ...
            while(!isValid)
            {
                Console.WriteLine("Błędne dane. Podaj liczbe nieujemną");
        ...
        static void Main(string[] args)
        {
            ...
            Operation substracking = new Operation(Substract);
            Operation multiplaying = new Operation(Multiply);
            Operation dividing = new Operation(Divide);

            DisplayResult(adding, a, b);
            DisplayResult(substracking, a, b);
            DisplayResult(multiplaying, a, b);
